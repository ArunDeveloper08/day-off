                            ...
                            onClick={() =>
                              onOpen("edit-trade", {
                                data: {
                                  ...
                                  case1RsiMax :item.case1RsiMax,
                                  case2RsiMax :item.case2RsiMax,
                                  case3RsiMax :item.case3RsiMax,
                                  case1TargetMf :item.case1TargetMf,
                                  case2TargetMf :item.case2TargetMf,
                                  case3TargetMf :item.case3TargetMf,
                                  case1DExitMf :item.case1DExitMf,
                                  case2DExitMf :item.case2DExitMf,
                                  case3DExitMf :item.case3DExitMf,
                                  case1CandleRatio :item.case1CandleRatio,
                                  case2CandleRatio :item.case2CandleRatio,
                                  case3CandleRatio :item.case3CandleRatio,
                                  case1MasterRsiReference :item.case1MasterRsiReference,
                                  case2MasterRsiReference :item.case2MasterRsiReference,
                                  case3MasterRsiReference :item.case3MasterRsiReference,
                                },
                                getAllTrades,
                                trades,
                              })
